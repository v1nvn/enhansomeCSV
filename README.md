...
* [QSV](https://github.com/dathere/qsv) ⭐ 3,536 | 🐛 47 | 🌐 Rust | 📅 2026-03-14 - A fast CSV command-line toolkit written in Rust, (an update to xsv).
...
* [awesome-public-datasets](https://github.com/awesomedata/awesome-public-datasets) ⭐ 73,401 | 🐛 140 | 📅 2026-03-10 - A topic-centric list of high-quality open datasets in public domains.
...
* [structured-text-tools](https://github.com/dbohdan/structured-text-tools) ⭐ 7,127 | 🐛 3 | 📅 2026-02-07 - List of command line tools for manipulating CSV / XML / HTML / JSON / INI etc.
