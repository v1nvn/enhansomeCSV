...
* [QSV](https://github.com/dathere/qsv) ⭐ 3,532 | 🐛 47 | 🌐 Rust | 📅 2026-03-13 - A fast CSV command-line toolkit written in Rust, (an update to xsv).
...
* [Data Wrangler](https://github.com/microsoft/vscode-data-wrangler) ⭐ 585 | 🐛 199 | 📅 2025-12-03 - Data Wrangler is a code-centric data cleaning tool that is integrated into VS Code and VS Code Jupyter Notebooks.
...
* [awesome-public-datasets](https://github.com/awesomedata/awesome-public-datasets) ⭐ 73,390 | 🐛 140 | 📅 2026-03-10 - A topic-centric list of high-quality open datasets in public domains.
...
* [structured-text-tools](https://github.com/dbohdan/structured-text-tools) ⭐ 7,126 | 🐛 3 | 📅 2026-02-07 - List of command line tools for manipulating CSV / XML / HTML / JSON / INI etc.
