...
* [QSV](https://github.com/dathere/qsv) ⭐ 3,465 | 🐛 56 | 🌐 Rust | 📅 2026-02-09 - A fast CSV command-line toolkit written in Rust, (an update to xsv).
...
* [awesome-public-datasets](https://github.com/awesomedata/awesome-public-datasets) ⭐ 72,702 | 🐛 135 | 📅 2026-01-30 - A topic-centric list of high-quality open datasets in public domains.
