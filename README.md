...
* [QSV](https://github.com/dathere/qsv) ⭐ 3,538 | 🐛 47 | 🌐 Rust | 📅 2026-03-14 - A fast CSV command-line toolkit written in Rust, (an update to xsv).
...
* [Rainbow CSV plugins](https://github.com/mechatroner/rainbow_csv#rainbow-csv-in-other-editors) ⭐ 699 | 🐛 20 | 🌐 Python | 📅 2025-10-04 - Collection of text editor plugins for CSV/TSV syntax highlighting. Available for [Vim](https://github.com/mechatroner/rainbow_csv) ⭐ 699 | 🐛 20 | 🌐 Python | 📅 2025-10-04, [VS Code](https://marketplace.visualstudio.com/items?itemName=mechatroner.rainbow-csv), [Atom](https://atom.io/packages/rainbow-csv), [Sublime Text](https://packagecontrol.io/packages/rainbow_csv) and other editors.
* [Data Wrangler](https://github.com/microsoft/vscode-data-wrangler) ⭐ 585 | 🐛 200 | 📅 2025-12-03 - Data Wrangler is a code-centric data cleaning tool that is integrated into VS Code and VS Code Jupyter Notebooks.
...
* [csvprintf](https://github.com/archiecobbs/csvprintf) ⭐ 43 | 🐛 2 | 🌐 C | 📅 2026-03-01 - UNIX command line utility for parsing and formatting output based on CSV files.
...
* [Csvlint.go](https://github.com/Clever/csvlint) ⭐ 205 | 🐛 14 | 🌐 Makefile | 📅 2025-11-05 - Command line tool for validating CSV files against RFC 4180.
...
* [CSV to Table](https://github.com/vividvilla/csvtotable) ⭐ 1,172 | 🐛 19 | 🌐 Python | 📅 2021-01-05 - Convert CSV files to searchable and sortable HTML table.
...
* [awesome-public-datasets](https://github.com/awesomedata/awesome-public-datasets) ⭐ 73,411 | 🐛 140 | 📅 2026-03-10 - A topic-centric list of high-quality open datasets in public domains.
...
* [structured-text-tools](https://github.com/dbohdan/structured-text-tools) ⭐ 7,128 | 🐛 3 | 📅 2026-02-07 - List of command line tools for manipulating CSV / XML / HTML / JSON / INI etc.
